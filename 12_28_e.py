...
with oraconn :
   ...
   oracle_e = ''' select EMPLOYEE_ID, FIRST_NAME, LAST_NAME, EMAIL, PHONE_NUMBER, HIRE_DATE, JOB_ID, NVL(SALARY,0), NVL(COMMISSION_PCT, 0), NVL(MANAGER_ID, 0), NVL(DEPARTMENT_ID,0) from EMPLOYEES'''
